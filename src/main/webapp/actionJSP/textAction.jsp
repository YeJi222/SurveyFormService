...
<%
	...
	if(request.getParameter("optionContent") != null){
		optionContent = request.getParameter("optionContent");
	}
	...
	int result = createDAO.updateTextType(surveyID, questionID, type, optionID, optionContent);
	if(result == -1){
